...
<head>
    ...
    <script src="<?php echo base_url('assets/dhtmlxGantt/codebase/dhtmlxgantt.js'); ?>"></script>
    <link href="<?php echo base_url('assets/dhtmlxGantt/codebase/dhtmlxgantt.css'); ?>" rel="stylesheet">
